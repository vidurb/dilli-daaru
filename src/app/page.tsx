...
import ProductCategories from "@/app/categories";
...
import {MobileThekaSearch} from "@/components/mobile-theka-search";
...
export default async function Home({
    ...
    const isTouched = productCategories.size !== allCategories.size || search.length > 0
    ...
    return (
        ...
        >
            ...
            <MobileDaaruSearch pathNameOverride={`/daaru`} />
            <MobileThekaSearch pathNameOverride={`/thekas`} />
        </main>
    )
}
